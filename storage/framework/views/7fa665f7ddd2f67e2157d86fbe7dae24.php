...
<body>
    ...
    <?php endif; ?>
            <div class="card-body">
                <form action="<?php echo e(route('event.update')); ?>" method="POST" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
                    <div class="mb-3">
                        <label for="exampleFormControlInput1" class="form-label">Banner</label>
                        <input type="text" class="form-control" value="<?php echo e($data->banner); ?>" name="banner" id="exampleFormControlInput1" placeholder="masukkan banner">
                      </div>
                      <div class="mb-3">
...
</html><?php /**PATH C:\Users\Lenovo\Desktop\AM\gigs-am\resources\views/backend/event/edit.blade.php ENDPATH**/ ?>